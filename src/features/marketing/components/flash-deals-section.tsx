...
export function FlashDealsSection() {
  ...
  const flashDeals = [
    ...
    },
    {
      ...
      discount: '28% OFF',
      image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuAXYyVKNJ2BKwV4vXJcryd0okqQlAEDG6zL1qgQuOi400blw4rrJEm1n33xAVB2M8s4rKLxQ1X7sGzwI6gtkR60dH5cZhmum7ik4wtIzIaYPn-ba2diVBz1NLu0jOtg3vVPj-Xef-vKmo91RYyxOUYMgP_4EbGM0_1gI0b8YBBpJcQcMODiJVUo_ypU2TDjf8fvGqfZvDQCALrF0QLdCwJ323fkOElTpKDXJJndJMOGDxg7JWz0TC8Xhw',
    ...
    {
      id: 'flash-3',
      title: 'OmniHub Pro Controller Unit',
      slug: 'omnihub-pro-controller',
      price: 179.0,
      originalPrice: 249.0,
      discount: '28% OFF',
      image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuA1LRjT9Ihz-8dgWb_3g0iESontfSPPGLRtpNUIcVHjvZo-AOe8kH7nknARQG4_lUV0kglcK1Zlrfvy0kio30xl-5Rl2ii_JZe_SGFYOSOPdCH3-fpkbV5MZmtn_Qwd5ryJbJLxjFkxpADru88twi87bsXww5uaa8kvdDUUX3KojUjlb795bZ2tPyLm2_GH1CxMEB3f3QSOgOVaBlxQNQHUs4hOdd9h2PHah42eqsSaasPixpq8-rgUIg',
      vendor: 'NexusTech',
      soldPercent: 65,
      stockLeft: 8,
    },
